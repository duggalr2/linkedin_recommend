...
if __name__ == "__main__":
    lines = open('Users/Rahul/Desktop/Main/Side_projects/linkedin_recommend/link_rec/temp_jobtitle_classifier/job_classified').readlines()
    lines = [line.replace('\n', '') for line in lines]
