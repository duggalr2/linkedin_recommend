# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-07-09 14:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_program', models.CharField(blank=True, max_length=500)),
                ('uo', models.TextField(blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job1', models.CharField(blank=True, max_length=500)),
                ('job2', models.CharField(blank=True, max_length=500)),
                ('job3', models.CharField(blank=True, max_length=500)),
                ('job4', models.CharField(blank=True, max_length=500)),
                ('job5', models.CharField(blank=True, max_length=500)),
                ('job6', models.CharField(blank=True, max_length=500)),
                ('job7', models.CharField(blank=True, max_length=500)),
                ('job8', models.CharField(blank=True, max_length=500)),
                ('job9', models.CharField(blank=True, max_length=500)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loc1', models.CharField(blank=True, max_length=500)),
                ('loc2', models.CharField(blank=True, max_length=500)),
                ('loc3', models.CharField(blank=True, max_length=500)),
                ('loc4', models.CharField(blank=True, max_length=500)),
                ('loc5', models.CharField(blank=True, max_length=500)),
                ('loc6', models.CharField(blank=True, max_length=500)),
                ('loc7', models.CharField(blank=True, max_length=500)),
                ('loc8', models.CharField(blank=True, max_length=500)),
                ('loc9', models.CharField(blank=True, max_length=500)),
            ],
